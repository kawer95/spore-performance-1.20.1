...
public final class OptimizationProfiles {
    ...
    private static final List<ForgeConfigSpec.BooleanValue> COMMON_REFACTOR = List.of(
            ...
            PerformanceConfig.REFACTOR_CALAMITY_PATH_REQUEST_REUSE,
            PerformanceConfig.REFACTOR_HOWITZER_INCREMENTAL_ORE_SCAN,
            PerformanceConfig.REFACTOR_HOWITZER_BURNABLE_FAST_SCAN,
