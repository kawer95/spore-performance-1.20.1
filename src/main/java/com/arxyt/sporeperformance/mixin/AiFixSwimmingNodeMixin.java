...
@Mixin(targets = "com.Harbinger.Spore.Sentities.AI.HybridPathNavigation$SwimmingNode", remap = false)
abstract class AiFixSwimmingNodeMixin extends SwimNodeEvaluator {
    protected AiFixSwimmingNodeMixin() { super(true); }
